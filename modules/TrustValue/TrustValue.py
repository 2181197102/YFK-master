...
class TrustElement:
    def __init__(self, ast_data, ob_data, ds_data, ap_data, at_data, similar_results,
                                           sensitive_results):
        self.InitTrust = 0
        ...
        self.ss = similar_results
        self.sensitive = sensitive_results
...
class TrustValue:
    def __init__(self, TrustElement: TrustElement):
        ...
        self.AT = 0.
        self.SS = 0.
        self.W = [0.15, 0.25, 0.25, 0.25, 0.05, 0.05]
        self.Uncertain = 0.75
    ...
    def SSValue2(self):
        ss_sum = 0
        for i in range(len(self.Trustelement.ss)):
            ss_sum+=self.Trustelement.ss[i]

        return ss_sum/len(self.Trustelement.ss)
